#
#  Be sure to run `pod spec lint ShareView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zhaoqiang"
  # s.authors            = { "zhaoqiang" => "zhaoqiang@hairuncf.com" }
  # s.social_media_url   = "http://twitter.com/zhaoqiang"
  ...
  s.source_files  = "ShareView/Classes/**/*.h"
